...
EOF
    ...
    echo "  git-force-push-this    - Force push current branch to origin"
    echo "  git-commit-all         - Add all changes and commit"
    echo "  git-reset-this         - Hard reset to HEAD (with confirmation)"
    echo "  git-new-branch         - Create and switch to a new branch"
    echo "  git-modify-branch      - Rename current branch"
    echo ""
    echo "Short aliases:"
    echo "  pit -s                 - Same as git-setup"
    echo "  pit -p                 - Same as git-push-this"
    echo "  pit -pf                - Same as git-force-push-this"
    echo "  pit -c \"msg\"           - Same as git-commit-all"
    echo "  pit -r                 - Same as git-reset-this"
    echo "  pit -b \"name\"          - Same as git-new-branch"
    echo "  pit -m \"name\"          - Same as git-modify-branch"
